...
//  EmojiArt
//
//  Created by Emma Walker - TVandMobile Platforms - Core Engineering on 09/10/2019.
...
{
    //once we have a view controller, we need to think about what is its' model
    //here it is a list of strings that will be our model
    var emojiArtDocuments = ["One", "Two", "Three"]

    // MARK: - UITableViewDataSource methods
    
    //at the moment we only have one section: emojiArtDocuments
    //you can imagine having more e.g. recently opened docs, recently deleted etc
    ...
    //we need the check so that setting preferredDisplayMode ITSELF doesn't cause layoutSubviews to be called repeatedly hence use an if
